...
if ($assetVersion === false) { $assetVersion = time(); }
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title><?= ucfirst(str_replace('.php', '', $current_page)) ?> - Smart Timetable Admin</title>
    ...
    <style>
        ...
        * { 
        ...
        button[type="submit"] {
            padding: 12px 24px;
            background: #6366F1; /* solid modern primary */
            color: white;
            border: none;
            border-radius: var(--radius-sm);
            cursor: pointer;
        ...
        .pill--blue { background: rgba(52,152,219,0.15); border-color: rgba(52,152,219,0.35); color: #7dc0e6; }
        .pill--yellow { background: rgba(241,196,15,0.15); border-color: rgba(241,196,15,0.35); color: #f3d36b; }
        .pill--purple { background: rgba(155,89,182,0.15); border-color: rgba(155,89,182,0.35); color: #caa0da; }
        ...
        .icon-btn:hover { background: rgba(255,255,255,0.05); border-color: var(--border-hover); }
        ...
        .stat-card .number {
            font-size: 42px;
            font-weight: 800;
            color: var(--accent-primary); /* Solid accent like ShadCN numbers */
        }
    ...
    <div class="container">
        ...
        <div class="sidebar ds-sidebar" id="sidebar">
            <div class="sidebar-header">
                <div style="padding: 10px 18px; background: rgba(255,255,255,0.08); border: 1px solid rgba(255,255,255,0.15); border-radius: 12px; text-align: center; margin-bottom: 28px; backdrop-filter: blur(10px); box-shadow: 0 2px 8px rgba(0,0,0,0.15);">
                    <span style="color: rgba(255,255,255,0.98); font-size: 13px; font-weight: 800; letter-spacing: 1px; text-transform: uppercase; font-family: 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; display: inline-block;">SMART TIMETABLE</span>
                </div>
                <div style="display: flex; align-items: center; gap: 10px; margin-bottom: 12px;">
                    <svg viewBox="0 0 24 24" style="width: 24px; height: 24px; color: rgba(255,255,255,0.8);" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
                        <path d="M12 2L2 7l10 5 10-5-10-5z"></path><path d="M2 17l10 5 10-5"></path><path d="M2 12l10 5 10-5"></path>
                    </svg>
                    <h1 style="margin: 0; font-size: 24px; font-weight: 700; color: rgba(255,255,255,0.95); letter-spacing: -0.5px; font-family: 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif;">Admin Console</h1>
                </div>
                <p class="admin-console-desc" style="color: rgba(220,230,255,0.75); font-size: 14px; line-height: 1.7; font-weight: 400; letter-spacing: -0.02em; font-family: 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; margin: 0;">Navigate every part of the timetable system through a single modern surface.</p>
            </div>
            
            <div class="sidebar-section">
                <div class="sidebar-section-title">OVERVIEW</div>
                <nav class="sidebar-nav">
                    <a href="<?= $baseHref ?>admin/index.php" class="<?= $current_page === 'index.php' ? 'active' : '' ?>"><i class="icon">
                        <!-- Grid icon (3x3) -->
                        <svg viewBox="0 0 24 24" aria-hidden="true"><rect x="3" y="3" width="5" height="5" rx="1"></rect><rect x="10" y="3" width="5" height="5" rx="1"></rect><rect x="17" y="3" width="5" height="5" rx="1"></rect><rect x="3" y="10" width="5" height="5" rx="1"></rect><rect x="10" y="10" width="5" height="5" rx="1"></rect><rect x="17" y="10" width="5" height="5" rx="1"></rect><rect x="3" y="17" width="5" height="5" rx="1"></rect><rect x="10" y="17" width="5" height="5" rx="1"></rect><rect x="17" y="17" width="5" height="5" rx="1"></rect></svg>
                    </i> Dashboard</a>
                </nav>
            </div>
            ...
            <div class="sidebar-section">
                ...
                <nav class="sidebar-nav">
                    <a href="<?= $baseHref ?>admin/programs.php" class="<?= $current_page === 'programs.php' ? 'active' : '' ?>"><i class="icon">
                        <!-- Chain/link icon -->
            ...
            <div class="sidebar-section">
                ...
                <nav class="sidebar-nav">
                    <a href="<?= $baseHref ?>admin/students.php" class="<?= $current_page === 'students.php' ? 'active' : '' ?>"><i class="icon">
                        <!-- lucide:users -->
                        <svg viewBox="0 0 24 24" aria-hidden="true"><path d="M16 21v-2a4 4 0 0 0-4-4H7a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><path d="M22 21v-2a4 4 0 0 0-3-3.87"></path><path d="M16 3.13a4 4 0 0 1 0 7.75"></path></svg>
                    </i> Students</a>
                    <a href="<?= $baseHref ?>admin/lecturers.php" class="<?= $current_page === 'lecturers.php' ? 'active' : '' ?>"><i class="icon">
                        <!-- lucide:users -->
                    ...
                    <a href="<?= $baseHref ?>admin/venues.php" class="<?= $current_page === 'venues.php' ? 'active' : '' ?>"><i class="icon">
                        <!-- lucide:map-pin -->
                        <svg viewBox="0 0 24 24" aria-hidden="true"><path d="M20.84 10.61A8 8 0 1 0 3.16 10.6L12 22l8.84-11.39z"></path><circle cx="12" cy="10" r="3"></circle></svg>
                    </i> Venues</a>
                </nav>
            </div>
            ...
            <div class="sidebar-section">
                ...
                <nav class="sidebar-nav">
                    <a href="<?= $baseHref ?>admin/modules.php" class="<?= $current_page === 'modules.php' ? 'active' : '' ?>"><i class="icon">
                        <!-- Book icon -->
                    ...
                    <a href="<?= $baseHref ?>timetable_pdf_parser.php" class="<?= $current_page === 'timetable_pdf_parser.php' ? 'active' : '' ?>"><i class="icon">
                        <!-- Calendar with plus -->
                        <svg viewBox="0 0 24 24" aria-hidden="true"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"></rect><line x1="16" y1="2" x2="16" y2="6"></line><line x1="8" y1="2" x2="8" y2="6"></line><line x1="3" y1="10" x2="21" y2="10"></line><line x1="12" y1="16" x2="12" y2="12"></line><line x1="10" y1="14" x2="14" y2="14"></line></svg>
                    </i> Add Session</a>
                    <a href="<?= $baseHref ?>timetable_editor.php" class="<?= $current_page === 'timetable_editor.php' ? 'active' : '' ?>"><i class="icon">
                        <!-- Edit/pencil icon -->
            ...
            <div class="sidebar-section">
                ...
                <nav class="sidebar-nav">
                    <a href="<?= $baseHref ?>admin/index.php"><i class="icon">
                        <!-- lucide:home -->
                        <svg viewBox="0 0 24 24" aria-hidden="true"><path d="M3 10l9-7 9 7"></path><path d="M9 22V12h6v10"></path></svg>
                    </i> Main Dashboard</a>
                    <a href="clear_data.php" class="<?= $current_page === 'clear_data.php' ? 'active' : '' ?>"><i class="icon">
                        <!-- lucide:trash-2 -->
                        <svg viewBox="0 0 24 24" aria-hidden="true"><path d="M3 6h18"></path><path d="M19 6v14c0 1-1 2-2 2H7c-1 0-2-1-2-2V6"></path><path d="M8 6V4c0-1 1-2 2-2h4c1 0 2 1 2 2v2"></path><line x1="10" y1="11" x2="10" y2="17"></line><line x1="14" y1="11" x2="14" y2="17"></line></svg>
                    </i> Clear Data</a>
